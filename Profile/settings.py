...
SECRET_KEY = 'django-insecure-pptu+!9v&zvu&^c&6mt-grfncdwztm!wn8g&@4v!bm6%hh^g@@'
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',                                  #username                                                                                                                                                                               ;LQM
        'PASSWORD': '',                                  # password blank
        'HOST': 'localhost',                             #localhost where the project is served
        'PORT': '3306'                                   #mysql 3306 default port
    }
}
